...
***
Caetano Veloso is one of the few artist to have kept a very constant level of valence and energy throughout is whole career. 
...
***
Tempo and track duration distributions per career category don't seem to have shifted throughout Caetano Veloso's career.
...
***
Caetano Veloso generally uses the same distribution of keys throughout his whole career, with an equal distriubtion of minor and major modes.
...
***
Throughout their career Daft Punk' songs have descended in valence and energy. As their latest work was more orchestral and diverse per track, it makes sense to have a lower average of valence and energy. 
...
While the early Daft Punk songs where super centered around 130 BPM, they've shifted to a wider range of tempo throughout their career. Track duration stayed generally the same througout their career.
...
***
An interesting view from this visual is the distribution of keys in the growth years of Daft Punk, where not all keys where used. They did however keep around the same distribution of minor and major modes troughout their career.
...
***
Fela Kuti's valence and energy scores are very consistent throughout his whole career. This could also be because of the small size of songs created in his Growth, Late and Mature years. 
...
***
For both tempo and track duration Fela Kuti doesn't seem to have a concise change per career category. This could also be because of the small size of songs created in his Growth, Late and Mature years. 
...
***
Remarkable to the key distribution per career category is the use of the key of G for songs of Fela Kuti's early, growth and matures years. 
...
***
Songs of Miles Davis have risen in both energy and valence throughout the years of Davis's career. Fitting with his style of playing in his early years which were songs of low energy.
...
***
While tempo and track duration are very wide distributed, they've remained roughly the same throughout Davis's career.
...
***
Throughout his whole career Miles Davis has used roughly the same distribution of keys and modes.
...
***
Radiohead is one of the few artists to have a big gap between valence and energy. While both measures have steadily declined throughout the first 3 phases of their career, they were almost more than ever during their most recent phase of their career.
...
***
While Radiohead changed throughout their career with the average of valence and energy, this can't be said about tempo and track duration. Both last named measures have been quite constant throughout their career.
...
***
Remarkable from the keygrams per career category is the growth of minor modes throughout their career. This would align with the decline in valence, since minor modes are often linked to sadder songs, but Radiohead's mature career category displays a high amount of minor modes but still scores high on average for valence.
...
***
Both measures, energy & valence, have not significantly changed throughout the career of the RHCP. Their energy scores the highest with an average of above 0,8.
...
***
As the average tempo has shifted a bit througout RHCP their career, it has not for their average track duration. Last topic has been cenetered around 4 minutes for their whole career.
...
***
The only significant shift in these keygram plots are the occurences of minor modes which has grown throughout the career of the Red Hot Chili Peppers.  
...
***
Youssou N'Dour's average energy and valence scores have stayed roughly the same throughout his career. This could be because of the Mbalax genre which Youssou N'Dour is most famous for.
...
***
Also the tempo and track duration distributions have stayed roughly the same throughout his career. This could also again be because of the Mbalax genre boundaries in which Youssou N'Dour has to stay.
...
***
As well for the keygrams for each part of his career, they've stayed roughly the same. His growth period is the only remarkablegraph, but it could be because of the small amount of tracks Youssou N'Dour released in that period.
...
***
For some artists  we see a decline in energy and valence; The Beatles, Björk, Daft Punk and Radiohead. Common denominators between these artists is the fact that they were prominent EU based artists throughout their careers. They also have experienced all with multiple genres of music. 

Other artists, who have experienced less with genres throughout their music journey seem to have changed less over time within the researched topics. Artists like Caetano Veloso, Fela Kuti, Miles Davis, RHCP and Youssou N'Dour are mostly all known for 1 genre respectively. Hence they show less change throughout their careers in topics like energy and valence.
...
facet_wrapped_tempo_duration <- ggplot(artist_album_corpus, aes(x = career_cat, y = mean_tempo, size = mean_track_duration )) +
  geom_point() + # or geom_point() if you prefer dots over lines
  facet_wrap(~ artist, scales = "free_x") + # Adjust ncol as needed for layout
  labs(title = "Tempo  per Career Category by Artist (sized by track duration)",
       x = "Career Category",
       y = "Mean Value",
       color = "Metric") +
  theme_minimal() +
...
***
For topics like tempo and track duration, the conclusion of valence and energy seems to be almost vice versa. For these topics it's the artists like Bjork, Caetano Veloso, Fela Kuti, Miles Davis and Youssou N'Dour who show the biggest changes in tempo and track duration throughout their career. Remarkably enough, Björk and RHCP have "switched".  

### Contribution
The contribution of this study lies in its  exploration of how artists evolve musically over the course of their careers, with a focus on several key metrics: energy, valence, tempo, and track duration. My findings highlight the intricate relationship between an artist's musical diversity—specifically, their engagement with multiple genres—and changes in their music's emotional and dynamic qualities over time.

One significant contribution of our analysis is the identification of patterns of change in energy and valence among artists who have been highly experimental with genres throughout their careers. Notably, European-based artists like The Beatles, Björk, Daft Punk, and Radiohead exhibit a decline in both energy and valence, suggesting a potential correlation between geographical location/social dynamics and genre experimentation with changes in these musical attributes. This observation opens up new avenues for understanding how cultural and regional influences might affect musical evolution.

Conversely, our study reveals that artists predominantly associated with a single genre—such as Caetano Veloso, Fela Kuti, Miles Davis, Red Hot Chili Peppers, and Youssou N'Dour—demonstrate less variability in energy and valence. This stability points to the influence of genre fidelity on maintaining consistent emotional and dynamic qualities in music, offering a contrasting perspective to the narrative of musical change.

Furthermore, the analysis extends to how tempo and track duration contrast with findings on energy and valence. Artists who have shown significant variability in their engagement with different genres also exhibit notable changes in tempo and track duration, except for a notable "switch" between artists like Björk and the Red Hot Chili Peppers compared to the trends observed in energy and valence. This inverse relationship between the sets of metrics underscores the complexity of musical evolution, suggesting that changes in one aspect of music may not always align with changes in others.

In sum, this study contributes to the broader discourse on musical evolution by providing empirical evidence of how genre experimentation and geographical factors may influence key musical characteristics over an artist's career. It challenges the simplistic notion of linear musical evolution and instead presents a multifaceted view that considers the impact of various external and intrinsic factors. This research not only enriches our understanding of musical dynamics but also lays the groundwork for future studies into the socio-cultural, technological, and personal factors that drive the musical journeys of artists.


# Chroma features?  (w9){.storyboard data-navmenu="Required visuals"} 
...
***
Here we see a dendogram of Björk's songs
