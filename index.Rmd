...
# catalog_size <- ggplot(corpus_by_artist, aes(x = reorder(artist, track_count), y = track_count, fill = artist)) +
#   geom_bar(stat = "identity") +
#   theme_minimal() +
#   labs(x = "Artist Name", y = "Size", title = "Catalog Size of Artists") +
#   coord_flip() # Flipping coordinates for better readability
# 
# catalog_length <- ggplot(corpus_by_artist, aes(x = reorder(artist, average_duration), y = average_duration, fill = artist)) +
#     geom_bar(stat = "identity") +
#     theme_minimal() +
#     labs(x = "Artist Name", y = "Length", title = "Catalog Length of Artists") +
#     coord_flip() #
# 
# plot_grid(catalog_size, catalog_length,
#           nrow= 2)
...
# Plot with faceting
ggplot(corpus_long, aes(x = reorder(artist, Value), y = Value, fill = artist)) +
  geom_bar(stat = "identity") +
  facet_wrap(~ Metric, scales = "free_x", labeller = label_parsed) +
  theme_minimal() +
  labs(x = "Artist Name", y = "Value") +
  coord_flip() +
