...
key_mode_plot <- ggplot(corpus_proportions, aes(x=key, y=proportion, fill=mode)) +
  ...
  labs(x="Key", y="Proportion", title="Proportions of Keys and Modes in Artist Discographies (Stacked Modes)") +
  theme_minimal() +
...
On the left we see the distribution of keys per artist
