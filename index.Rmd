...
catalog_bar_charts <- ggplot(corpus_long, aes(x = reorder(artist, Value), y = Value, fill = artist)) +
  ...
  theme_minimal() +
  labs(x = "Artist Name", y = " ", title = "Catalog size by artist", fill = "Artist") +  # Added a plot title
  coord_flip() +
...
### How does the career of the Beatles look like?
```{r, echo=FALSE}
...
ggplot(mean_energy, aes(x = career_cat, y = mean_energy, fill = career_cat)) +
  geom_col() +
  labs(x = "Career Category", y = "Mean Energy", fill = "Career Category") +
  theme_minimal()

mean_valence <- beatles_corpus %>%
  group_by(career_cat) %>%
  summarise(mean_valence = mean(valence, na.rm = TRUE))
ggplot(mean_valence, aes(x = career_cat, y = mean_valence, fill = career_cat)) +
  geom_col() +
  labs(x = "Career Category", y = "Mean Energy", fill = "Career Category") +
  theme_minimal()
...
### Analysis
```{r beatles_valence_energy, echo=FALSE, fig.width=10}

# valence <- ggplot(beatles_corpus, aes(x = valence, fill = career_cat)) +
#   geom_density(alpha = 0.5) + 
#   labs(title = "Density Plot by Career Category", x = "Valence",
#        fill = "Career Category") +
#   theme_minimal() +
#   scale_fill_brewer(palette = "Set1")
# 
# energy <- ggplot(beatles_corpus, aes(x = energy, fill = career_cat)) +
#   geom_density(alpha = 0.5) + 
#   labs(title = "Density Plot by Career Category", x = "Energy",
#        fill = "Career Category") +
#   theme_minimal() +
#   scale_fill_brewer(palette = "Set1")

valence_plot <- create_density_plot(beatles_corpus, "valence", "Density Plot by Career Category", "Valence")
energy_plot <- create_density_plot(beatles_corpus, "energy", "Density Plot by Career Category", "Energy")

# Combine the plots
plot_grid(valence_plot, energy_plot, ncol = 1)
...
### How does the career of Björk look like?
```{r, echo=FALSE}
bjork_corpus <- corpus %>%
  filter(artist == "Bjork")
...
### Analysis
```{r bjork_valence_energy, fig.width=10}
valence_plot <- create_density_plot(beatles_corpus, "valence", "Density Plot by Career Category", "Valence")
energy_plot <- create_density_plot(beatles_corpus, "energy", "Density Plot by Career Category", "Energy")
...
### How does the career of Caetano Veloso look like?
```{r}
...
### Analysis
```{r caetano_valence_energy, fig.width=10}
# Use the function to create plots
valence_plot <- create_density_plot(caetano_veloso_corpus, "valence", "Density Plot by Career Category", "Valence")
energy_plot <- create_density_plot(caetano_veloso_corpus, "energy", "Density Plot by Career Category", "Energy")
...
### Analysis
```{r daft_valence_energy, fig.width=10}
# Use the function to create plots
valence_plot <- create_density_plot(daft_punk_corpus, "valence", "Density Plot by Career Category", "Valence")
energy_plot <- create_density_plot(daft_punk_corpus, "energy", "Density Plot by Career Category", "Energy")
...
### How does the career of Fela Kuti look like?
...
### Analysis
```{r fela_valence_energy, fig.width=10}
# Use the function to create plots
valence_plot <- create_density_plot(fela_kuti_corpus, "valence", "Density Plot by Career Category", "Valence")
energy_plot <- create_density_plot(fela_kuti_corpus, "energy", "Density Plot by Career Category", "Energy")
...
### How does the career of Miles Davis look like?
```{r}
...
### Analysis
```{r miles_valence_energy, fig.width=10}
 # Use the function to create plots
valence_plot <- create_density_plot(miles_davis_corpus, "valence", "Density Plot by Career Category", "Valence")
energy_plot <- create_density_plot(miles_davis_corpus, "energy", "Density Plot by Career Category", "Energy")
...
### How does the career of Radiohead look like?
...
### Analysis
```{r radiohead_valence_energy, fig.width=10}
# Use the function to create plots
valence_plot <- create_density_plot(radiohead_corpus, "valence", "Density Plot by Career Category", "Valence")
energy_plot <- create_density_plot(radiohead_corpus, "energy", "Density Plot by Career Category", "Energy")
...
***
Listen to Red Hot Chili Peppers here:
...
### How does the career of Red Hot Chili Peppers look like?
```{r}
rhcp_corpus <- corpus %>%
  filter(artist == "RHCP")
...
Sidebar text
### Analysis
```{r rhcp_valence_energy, fig.width=10}
# Use the function to create plots
valence_plot <- create_density_plot(rhcp_corpus, "valence", "Density Plot by Career Category", "Valence")
energy_plot <- create_density_plot(rhcp_corpus, "energy", "Density Plot by Career Category", "Energy")
...
### How does the career of Youssou N'Dour look like?
```{r}
...
Sidebar text
### Analysis
```{r youssou_valence_energy, fig.width=10}
# Use the function to create plots
valence_plot <- create_density_plot(youssou_corpus, "valence", "Density Plot by Career Category", "Valence")
energy_plot <- create_density_plot(youssou_corpus, "energy", "Density Plot by Career Category", "Energy")
...
# Clustering (w12) {.storyboard data-navmenu=Homework}
### Histogram
...
# Tempigram (w11) {.storyboard data-navmenu=Homework}
### Histogram
...
### How do the chroma features look like?
