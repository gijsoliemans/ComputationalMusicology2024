...
valence <- ggplot(beatles_corpus, aes(x = valence, fill = career_cat)) +
  ...
  labs(title = "Density Plot by Career Category",
...
### Analysis
```{r}
track_data <- ggplot(bjork_corpus, aes(x = track_duration_minutes, fill = career_cat)) +
  geom_density(alpha = 0.5) + 
  labs(title = "Density Plot by Career Category",
       fill = "Career Category") +
  theme_minimal() +
...
### Analysis
```{r}
track_data <- ggplot(caetano_veloso_corpus, aes(x = valence, fill = career_cat)) +
  geom_density(alpha = 0.5) + 
  labs(title = "Density Plot by Career Category",
       fill = "Career Category") +
  theme_minimal() +
...
### Analysis
```{r}
track_data <- ggplot(daft_punk_corpus, aes(x = valence, fill = career_cat)) +
  geom_density(alpha = 0.5) + 
  labs(title = "Density Plot by Career Category",
       fill = "Career Category") +
  theme_minimal() +
...
### Analysis
```{r}
track_data <- ggplot(fela_kuti_corpus, aes(x = valence, fill = career_cat)) +
  geom_density(alpha = 0.5) + 
  labs(title = "Density Plot by Career Category",
       fill = "Career Category") +
  theme_minimal() +
...
### Analysis
```{r}
track_data <- ggplot(miles_davis_corpus, aes(x = track_duration_minutes, fill = career_cat)) +
  geom_density(alpha = 0.5) + 
  labs(title = "Density Plot of Energy by Career Category",
       x = "Energy",
       y = "Density",
       fill = "Career Category") +
  theme_minimal() +
...
### Analysis
```{r}
track_data <- ggplot(radiohead_corpus, aes(x = valence, fill = career_cat)) +
  geom_density(alpha = 0.5) + 
  labs(title = "Density Plot by Career Category",
       fill = "Career Category") +
  theme_minimal() +
...
### Analysis
```{r}
track_data <- ggplot(rhcp_corpus, aes(x = track_duration_minutes, fill = career_cat)) +
  geom_density(alpha = 0.5) + 
  labs(title = "Density Plot by Career Category",
       fill = "Career Category") +
  theme_minimal() +
...
### Analysis
```{r}
track_data <- ggplot(youssou_corpus, aes(x = valence, fill = career_cat)) +
  geom_density(alpha = 0.5) + 
  labs(title = "Density Plot by Career Category",
       fill = "Career Category") +
  theme_minimal() +
