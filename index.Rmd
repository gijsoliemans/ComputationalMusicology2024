...
track_plot <- ggplot(corpus, aes(x = energy, y = valence, color = danceability, text = track_info, alpha = 0.8)) +
  geom_point() +
  facet_wrap(~artist) +
  labs(title = "Valence vs Energy colored by danceability per artist", 
       color = "Danceability") + # Title for the color scale
  theme_minimal() +
...
plot_grid(lowest_energy_valence_chromagram, highest_energy_valence_chromagram, ncol=1)
```
