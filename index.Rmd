...
***
For each artist in my corpus the following topics are discussed: energy, valence, tempo, track length, key. By combining these topics we create a fundament to try to understand the music of an artist.  
In order to create insights in the musical journey of artists I've adjusted the corpus for every artist in 4 "career categories"
